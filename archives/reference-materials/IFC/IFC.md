...
▫ Window (rectangular): Window with \'shape *rectangular\'*, sole plate height \> 0.3m above BE wall.
...
4th level *IFC ObjectType*: Free Type-definition as subtype to IFC-Elementtyp (IFC Identifier). Here too, the entries often define a cross section: E.g. the entry 'HEA 200' can be entered here for an IFCBeam (girder).
...
### %DHPKOL%\\#203\\#206\\68-78\\#525\\#2271 {#dhpkol20320668-785252271 .unnumbered}
...
-   Free attributes can be used in the assignment with the same syntax as in the conditions. In order to identify the string as a variable, it has to be enclosed in #. Example: **V_WinRef=#PSet_WindowCommon\~Reference#**
...
3.10.6.2[Example: Setting user prompt variables for assigned Logic Blocks]{.underline}
...
1.  [Dimensions of openings]{.underline}
...
-   Types for doors from IFC: **IfcDoorStyle_OperationType**
...
1.  []{#_bookmark4 .anchor}**Conditions according to free attributes**
...
[Log file for IFC import:]{.underline}
...
-   (20.03) *Material output:* In the IFC export, the material (IfcMaterial) can now optionally be transferred from the item number or order number. Since the item number is partly aligned to internal processes, the order number is the more generally valid information and more suitable for communication with partners.
...
+-------------------------+------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > DoublePanelHorizontal | > Window with two panels. The configuration of the panels is horizontally.   | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcWindowStyleOperationEnum-Fig03.gif](mediaIFC/media/image3.png){width="1.1874989063867016in" height="1.1875in"}             |
+-------------------------+------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > TriplePanelTop                           | > Window with three panels. The configuration of two panels is vertically and the third one is horizontally at the top.             | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcWindowStyleOperationEnum-Fig07.gif](mediaIFC/media/image7.png){width="1.1874989063867016in" height="1.7708333333333333in"} |
+--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------------------------------------+-------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > TriplePanelTop                           | > first IfcWindowPanelProperties with PanelPosition = TOP                                                               | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcWindowPanelPositionEnum-Fig06.gif](mediaIFC/media/image28.png){width="1.4691262029746281in" height="2.0625in"}            |
|                                            | >                                                                                                                       |                                                                                                                                                                                                      |
...
+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------+
| > SINGLE_SWING_RIGHT         | > Door with one panel that opens (swings) to the right. The hinges are on the right side as viewed in the direction of the positive y-axis. | > ![single swing right](mediaIFC/media/image32.png){width="1.375in" height="0.8958333333333334in"}            |
|                              | >                                                                                                                                           |                                                                                                               |
|                              | > Note: Direction of swing (whether in or out) is determined at the *IfcDoor*.                                                              |                                                                                                               |
+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------+
| > DOUBLE_DOOR\_ SINGLE_SWING | > Door with two panels, one opens (swings) to the left the other opens (swings) to the right.                                               | > ![double swing](mediaIFC/media/image33.png){width="1.375in" height="0.6354166666666666in"}                  |
|                              | >                                                                                                                                           |                                                                                                               |
|                              | > Note: Direction of swing (whether in or out) is determined at the *IfcDoor*.                                                              |                                                                                                               |
+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------+
| > DOUBLE_SWING_LEFT          | > Door with one panel that swings in both directions and to the left in the main trafic direction. Also called double acting door.          | > ![double swing left](mediaIFC/media/image34.png){width="1.380751312335958in" height="1.4566666666666668in"} |
|                              | >                                                                                                                                           |                                                                                                               |
...
| Dietrich\'s ***IFC_Ud22.docx*** Version 22    |                                                                                                                                                                                            |                                                                                                             |
+===============================================+============================================================================================================================================================================================+=============================================================================================================+
| > DOUBLE_SWING_RIGHT                          | > Door with one panel that swings in both directions and to the right in the main trafic direction. Also called double acting door.                                                        | > ![double swing right](mediaIFC/media/image35.png){width="1.375in" height="1.59375in"}                     |
|                                               | >                                                                                                                                                                                          |                                                                                                             |
|                                               | > Note: Direction of main swing (whether in or out) is determined at the *IfcDoor*.                                                                                                        |                                                                                                             |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > DOUBLE_DOOR\_ DOUBLE_SWING                  | > Door with two panels, one swings in both directions and to the right in the main trafic direction the other swings also in both directions and to the left in the main trafic direction. | > ![double double swing](mediaIFC/media/image36.png){width="1.375in" height="0.9791666666666666in"}         |
|                                               | >                                                                                                                                                                                          |                                                                                                             |
|                                               | > Note: Direction of main swing (whether in or out) is determined at the *IfcDoor*.                                                                                                        |                                                                                                             |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > DOUBLE_DOOR\_ SINGLE_SWING\_ OPPOSITE_LEFT  | > Door with two panels that both open to the left, one panel swings in one direction and the other panel swings in the opposite direction.                                                 | > ![opposite left](mediaIFC/media/image37.png){width="1.375in" height="1.0in"}                              |
|                                               | >                                                                                                                                                                                          |                                                                                                             |
|                                               | > Note: Direction of main swing (whether in or out) is determined at the *IfcDoor*.                                                                                                        |                                                                                                             |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > DOUBLE_DOOR\_ SINGLE_SWING\_ OPPOSITE_RIGHT | > Door with two panels that both open to the right, one panel swings in one direction and the other panel swings in the opposite direction.                                                | > ![opposite right](mediaIFC/media/image38.png){width="1.375in" height="1.0208333333333333in"}              |
|                                               | >                                                                                                                                                                                          |                                                                                                             |
|                                               | > Note: Direction of main swing (whether in or out) is determined at the *IfcDoor*.                                                                                                        |                                                                                                             |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > SLIDING_TO_LEFT                             | > Door with one panel that is sliding to the left.                                                                                                                                         | > ![sliding to left](mediaIFC/media/image39.png){width="1.375in" height="0.6770833333333334in"}             |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > SLIDING_TO_RIGHT                            | > Door with one panel that is sliding to the right.                                                                                                                                        | > ![sliding to right](mediaIFC/media/image40.png){width="1.375in" height="0.6770833333333334in"}            |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > DOUBLE_DOOR_SLIDING                         | > Door with two panels, one is sliding to the left the other is sliding to the right.                                                                                                      | > ![double sliding](mediaIFC/media/image41.png){width="1.3762740594925635in" height="0.6979166666666666in"} |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > FOLDING_TO_LEFT                             | > Door with one panel that is folding to the left.                                                                                                                                         | > ![folding to left](mediaIFC/media/image42.png){width="1.375in" height="0.7708333333333334in"}             |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > FOLDING_TO_RIGHT                            | > Door with one panel that is folding to the right.                                                                                                                                        | > ![folding to right](mediaIFC/media/image43.png){width="1.375in" height="0.7708333333333334in"}            |
+-----------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+

+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| Dietrich\'s ***IFC_Ud22.docx*** Version 22 |                                                                                                                                                                                          |                                                                                                             |
+============================================+==========================================================================================================================================================================================+=============================================================================================================+
| > DOUBLE_DOOR_FOLDING                      | > Door with two panels, one is folding to the left the other is folding to the right.                                                                                                    | > ![double folding](mediaIFC/media/image44.png){width="1.3797101924759405in" height="0.7177077865266842in"} |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > REVOLVING                                | > An entrance door consisting of four leaves set in a form of a cross and revolving around a central vertical axis (the four panels are described by a single *IfcDoor* panel property). | > ![revolving](mediaIFC/media/image45.png){width="1.375748031496063in" height="0.96875in"}                  |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > ROLLINGUP                                | > Door that opens by rolling up.                                                                                                                                                         | > ![rolling](mediaIFC/media/image46.png){width="1.375in" height="1.375in"}                                  |
|                                            | >                                                                                                                                                                                        |                                                                                                             |
|                                            | > Note: Whether it rolls up to the inside or outside is determined at the *IfcDoor*.                                                                                                     |                                                                                                             |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > USERDEFINED                              | > User defined operation type                                                                                                                                                            |                                                                                                             |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
| > NOTDEFINED                               | > A door with a not defined operation type is considered as a door with a lining, but no panels. It is thereby always open.                                                              | > ![not defined](mediaIFC/media/image47.png){width="1.375in" height="0.7083333333333334in"}                 |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------+
...
5.  The location of the panel relative to the wall thickness is defined by the *ObjectPlacement* at

> *IfcDoor*, and the *IfcDoorLiningProperties.LiningOffset* parameter.

TYPE IfcDoorStyleOperationEnum = ENUMERATION OF ( SINGLE_SWING_LEFT, SINGLE_SWING_RIGHT, DOUBLE_DOOR_SINGLE_SWING,

> DOUBLE_DOOR_SINGLE_SWING_OPPOSITE_LEFT, DOUBLE_DOOR_SINGLE_SWING_OPPOSITE_RIGHT, DOUBLE_SWING_LEFT,
>
> DOUBLE_SWING_RIGHT, DOUBLE_DOOR_DOUBLE_SWING, SLIDING_TO_LEFT, SLIDING_TO_RIGHT,
>
> DOUBLE_DOOR_SLIDING, FOLDING_TO_LEFT, FOLDING_TO_RIGHT, DOUBLE_DOOR_FOLDING, REVOLVING,
>
...
![panel direction](mediaIFC/media/image48.png){width="6.178125546806649in" height="2.0416666666666665in"}

### Door -- sashes -- opening type of a single sash

+--------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > Swinging                     | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcDoorPanelOperationEnum-Fig01.gif](mediaIFC/media/image49.png){width="1.3854155730533684in" height="0.9895833333333334in"} |
+================================+======================================================================================================================================================================================================+
| > DoubleActing                 | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcDoorPanelOperationEnum-Fig02.gif](mediaIFC/media/image50.png){width="1.3854155730533684in" height="1.5833333333333333in"} |
+--------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

+--------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > Sliding                      | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcDoorPanelOperationEnum-Fig03.gif](mediaIFC/media/image51.png){width="1.3749989063867016in" height="0.2916666666666667in"} |
+================================+======================================================================================================================================================================================================+
| > Folding                      | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcDoorPanelOperationEnum-Fig04.gif](mediaIFC/media/image52.png){width="1.3854155730533684in" height="0.3958333333333333in"} |
+--------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > Revolving                    | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcDoorPanelOperationEnum-Fig05.gif](mediaIFC/media/image53.png){width="1.3854155730533684in" height="0.7916666666666666in"} |
+--------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > Rollingup                    | > ![D:\\koop\\IFC\\R2x3_final\\ifcsharedbldgelements\\lexical\\Figures\\IfcDoorPanelOperationEnum-Fig06.gif](mediaIFC/media/image54.png){width="1.3854155730533684in" height="0.84375in"}            |
+--------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > UserDefined                  |                                                                                                                                                                                                      |
+--------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| > NotDefined                   |                                                                                                                                                                                                      |
...
> DOUBLE_ACTING, SLIDING, FOLDING, REVOLVING, ROLLINGUP, USERDEFINED, NOTDEFINED);
...
+--------------+---------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------+
| > 15.01.2017 | > [Properties of windows and doors](#properties-of-windows-and-doors-that-can-be-interpreted-by-the-import) that can be interpreted by the import | > Addition tot he section: *Opening type and hinge side for window sash from IFC*. |
+--------------+---------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------+
| > 16.01.2017 | > Opening type and hinge side for window sash from IFC: IfcWindowPanelProperties                                                                  | > New chapter: *Opening type and hinge side for window sash from IFC*.             |
+--------------+---------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------+
| > 16.01.2017 | > Opening info                                                                                                                                    | > Addition tot he section: *Opening type and hinge side for window sash from IFC*. |
+--------------+---------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------+
...
+--------------+-----------------------------------------------------------+----------------------------------------------------------------------------+
| > 16.01.2017 | > Settings, types and Logic Blocks that can be assigned   | > Additions in the subchapters if multiple Assign Items apply              |
|              | >                                                         |                                                                            |
|              | > Setting variables for the assigned Logic Blocks         |                                                                            |
+--------------+-----------------------------------------------------------+----------------------------------------------------------------------------+
| > 16.01.2017 | > IFC Viewer                                              | > New link to FZK-viewer                                                   |
+--------------+-----------------------------------------------------------+----------------------------------------------------------------------------+
| > 16.01.2017 | > Free MOS für imported                                   | > New chapter                                                              |
|              | >                                                         |                                                                            |
|              | > components                                              |                                                                            |
+--------------+-----------------------------------------------------------+----------------------------------------------------------------------------+
...
+--------------+-----------------------------------------------------------+----------------------------------------------------------------------------+
| > 21.01.21   | > IFC Export: default settings for export                 | > Material output via item number or order number                          |
|              | >                                                         | >                                                                          |
|              | > Rules for the IFC-Export of structural objects          | > Identifier (20.03)                                                       |
+--------------+-----------------------------------------------------------+----------------------------------------------------------------------------+
